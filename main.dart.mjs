...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1309: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1521: (o, p) => p in o,
      _1522: (o, p) => o[p],
      _1525: (x0,x1,x2) => x0.transaction(x1,x2),
      _1526: (x0,x1) => x0.objectStore(x1),
      _1527: (x0,x1) => x0.getAllKeys(x1),
      _1528: (x0,x1) => x0.getAll(x1),
      _1529: (x0,x1) => x0.get(x1),
      _1530: (x0,x1) => x0.delete(x1),
      _1531: (x0,x1,x2) => x0.put(x1,x2),
      _1533: x0 => x0.close(),
      _1534: (x0,x1) => x0.deleteDatabase(x1),
      _1535: (x0,x1,x2) => x0.open(x1,x2),
      _1536: (x0,x1) => x0.contains(x1),
      _1537: (x0,x1) => x0.deleteObjectStore(x1),
      _1538: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1538(f,arguments.length,x0) }),
      _1539: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1570: (x0,x1,x2) => x0.open(x1,x2),
      _1571: x0 => x0.abort(),
      _1572: x0 => x0.getAllResponseHeaders(),
      ...
      _1751: x0 => x0.readyState,
      _1753: (x0,x1) => { x0.timeout = x1 },
      _1755: (x0,x1) => { x0.withCredentials = x1 },
      _1756: x0 => x0.upload,
      _1757: x0 => x0.responseURL,
      _1758: x0 => x0.status,
      _1759: x0 => x0.statusText,
      _1761: (x0,x1) => { x0.responseType = x1 },
