...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      EJ: (o, offsetInBytes, lengthInBytes) => {
      ...
      GI: x0 => x0.disabled,
      GJ: (x0,x1) => x0.getRandomValues(x1),
      GK: x0 => x0.classList,
      GL: x0 => x0.location,
      ...
      II: (x0,x1) => { x0.max = x1 },
      IJ: l => new DataView(new ArrayBuffer(l)),
      IK: x0 => x0.head,
      IL: x0 => x0.metaKey,
      ...
      YK: (x0,x1,x2) => x0.transaction(x1,x2),
      YL: (x0,x1) => new OffscreenCanvas(x0,x1),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      gI: x0 => x0.URL,
      gJ: x0 => x0.upload,
      gK: (x0,x1) => x0.deleteObjectStore(x1),
      ...
      jJ: x0 => x0.getAllResponseHeaders(),
      jK: x0 => x0.indexedDB,
      k: o => o,
      kB: o => {
        if (o === null || o === undefined) return 0;
      ...
      nJ: (x0,x1) => { x0.timeout = x1 },
      nK: (x0,x1) => x0.createObjectStore(x1),
      ...
      pI: x0 => x0.ready,
      pJ: (x0,x1) => { x0.withCredentials = x1 },
      pK: x0 => x0.objectStoreNames,
      ...
      sJ: (x0,x1,x2) => x0.insertRule(x1,x2),
      sK: (x0,x1) => { x0.onupgradeneeded = x1 },
      t: (o, p, v) => o[p] = v,
